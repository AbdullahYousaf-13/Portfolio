...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mohammad Abdullah — Cybersecurity Analyst" },
      { name: "description", content: description },
      { name: "author", content: "Mohammad Abdullah" },
      { property: "og:title", content: "Mohammad Abdullah — Cybersecurity Analyst" },
      { property: "og:description", content: description },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Mohammad Abdullah — Cybersecurity Analyst" },
