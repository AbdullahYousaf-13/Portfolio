            ...
            return (
              ...
              >
                <div
                  ...
                  style={{ background: "oklch(0.72 0.14 195 / 0.16)" }}
                />
                ...
                <div className="relative mt-6 flex flex-wrap gap-1.5">
                  {group.items.map((item) => (
                    <span
                      key={item}
                      className="rounded-md border border-border bg-surface-2 px-2.5 py-1 font-mono text-[11px] text-foreground/85 transition-colors hover:border-primary/60 hover:text-primary"
                    >
                      {item}
                    </span>
                  ))}
