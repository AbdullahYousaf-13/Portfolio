      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          <motion.div
            ...
            className="panel p-7 md:p-9 lg:col-span-7"
          >
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={t}
                  className="rounded-full border border-border bg-accent/60 px-3 py-1 font-mono text-[11px] text-muted-foreground"
                >
                  {t}
                </span>
              ))}
                ...
                {profile.learningRepos.map((r) => (
                  <li key={r.name}>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="group flex items-center justify-between py-2.5 text-sm text-foreground/90 transition-colors hover:text-primary"
                    >
