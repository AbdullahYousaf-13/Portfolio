      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          <motion.div
            ...
            className="panel p-7 md:p-9 lg:col-span-5"
          >
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 flex flex-wrap gap-1.5">
                {education.coursework.map((c) => (
                  <span
                    key={c}
                    className="rounded-md border border-border bg-surface-2 px-2 py-1 font-mono text-[10px] text-foreground/80"
                  >
                    {c}
                  </span>
                ))}
          ...
          >
            ...
            <ul className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {credentials.map((c) => (
                <li
                  key={c.name}
                  className="panel group relative overflow-hidden p-5 transition-transform hover:-translate-y-0.5"
                >
                  <div
                    aria-hidden
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, transparent, oklch(0.72 0.14 195 / 0.8), transparent)",
                    }}
                  />
